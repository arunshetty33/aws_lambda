#The Lambda function calls EC2 to list all EC2 instances, The function calls EBS for each instance to find attached EBS volumes
#Referance: https://www.techgig.com/digital/amazonaws/blogathon
