...
def lambda_handler(event, context):
    ...
    #Give your file path
    filepath ='/tmp/HG_AWS_Resources_' + date_fmt + '.csv'
    #Give your filename
    filename ='HG_AWS_Resources_' + date_fmt + '.csv'
    ...
    def mail(fromadd,to, subject, text, attach):
       ...
       msg.attach(part)
       mailServer = smtplib.SMTP("email-smtp.us-east-1.amazonaws.com", 25)
       mailServer.ehlo()
       mailServer.starttls()
       mailServer.ehlo()
    ...
    filepath ='/tmp/HG_AWS_Resources_' + date_fmt + '.csv'
    #Give your filename
    mail("varkumar@firstam.com","HG Cloud AWS Resources","PFA for the AWS resource of HG account.",filepath)
    s3.Object('arun-powercloud-inventory', filename).put(Body=open(filepath, 'rb'))